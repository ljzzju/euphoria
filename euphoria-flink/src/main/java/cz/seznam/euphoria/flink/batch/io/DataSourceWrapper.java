...
public class DataSourceWrapper<T>
        ...
        PartitionWrapper<T>>,
        ResultTypeQueryable<BatchElement<GlobalWindowing.Window, T>> {
  ...
  @Override
  public TypeInformation<BatchElement<GlobalWindowing.Window, T>> getProducedType() {
    return TypeSupport.forBatchElement(GlobalWindowing.get().getWindowType(), (ResultType<T>) null);
  }
}
