...
public interface Windowing<T, W extends Window> extends Serializable {
  ...
  /**
   * Retrieves type information about the specific type of windows this
   * windowing strategy produces.<p>
   *
   * The default implementation of this method returns {@code null}.
   * Implementors of this interface general do want to override this
   * method and provide a type hint to enable runtimes perform
   * de-/serialization specific optimizations.
   *
   * @return {@code null} if the type of windows generated by this windowing
